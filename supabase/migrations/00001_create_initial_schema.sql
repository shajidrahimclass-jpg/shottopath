...
INSERT INTO storage.buckets (id, name, public) VALUES ('shottopoth_images', 'shottopoth_images', true);

-- Storage policies for images
CREATE POLICY "Public can view images" ON storage.objects FOR SELECT USING (bucket_id = 'shottopoth_images');
CREATE POLICY "Authenticated users can upload images" ON storage.objects FOR INSERT TO authenticated WITH CHECK (bucket_id = 'shottopoth_images');
CREATE POLICY "Users can update own images" ON storage.objects FOR UPDATE TO authenticated USING (bucket_id = 'shottopoth_images');
CREATE POLICY "Users can delete own images" ON storage.objects FOR DELETE TO authenticated USING (bucket_id = 'shottopoth_images');
