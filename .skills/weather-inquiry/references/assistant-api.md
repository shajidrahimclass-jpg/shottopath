...
**Endpoint**: `POST https://app-9cyfgucqbpj5-api-79jKPlpvAJ0L.gateway.appmedo.com/assistant/session`
...
**Endpoint**: `POST https://app-9cyfgucqbpj5-api-oYA6ZxVqyK8a.gateway.appmedo.com/assistant/session/{session_id}`
