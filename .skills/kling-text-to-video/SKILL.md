...
| Property | Value |
|----------|-------|
| Submit Endpoint | `POST https://app-9cyfgucqbpj5-api-qYGWo8XA7JVY.gateway.appmedo.com/v1/videos/text2video` |
| Query Endpoint | `GET https://app-9cyfgucqbpj5-api-oLpZ7eD5j2Pa.gateway.appmedo.com/v1/videos/text2video/{id}` |
