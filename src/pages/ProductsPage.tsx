  ...
  return (
    <MainLayout>
      ...
      <PullToRefresh onRefresh={handleRefresh}>
        ...
        {/* Banner Carousel */}
        {banners.length > 0 && (
          <div className="relative w-full aspect-[16/6] min-h-[160px] rounded-xl overflow-hidden mb-6 md:mb-10 shadow-lg">
        ...
        <div className="mb-8 md:mb-10">
          <h1 className="text-xl md:text-3xl lg:text-4xl font-bold mb-4 md:mb-6 animate-in slide-in-from-top duration-500 bg-gradient-to-r from-foreground to-foreground/70 bg-clip-text text-transparent">
            Product Categories
          </h1>
          
          {/* Search Bar */}
          <div className="relative w-full max-w-2xl mb-5 md:mb-6">
          ...
          {/* Category Filter */}
          <div className="flex flex-wrap gap-1.5 md:gap-2 animate-in slide-in-from-left duration-700">
            <Badge
              variant={selectedCategory === 'all' ? 'default' : 'outline'}
              className="cursor-pointer px-2 py-1 md:px-4 md:py-2 text-xs md:text-sm font-medium transition-all duration-200 hover:scale-105 hover:shadow-md"
            ...
            {categories.length > MAX_VISIBLE_CATEGORIES && (
              <Badge
                variant="outline"
                className="cursor-pointer px-2 py-1 md:px-4 md:py-2 text-xs md:text-sm font-medium transition-all duration-200 hover:scale-105 hover:shadow-md flex items-center gap-1"
