...
export default function MobileLoginPage() {
  ...
  return (
    ...
    <PageTransition><div className="flex flex-col min-h-screen max-w-md mx-auto bg-background overflow-x-hidden"
      ...
      {/* ── Hero / brand section ──────────────────────────────── */}
      <div className="relative overflow-hidden shrink-0" style={{ background: 'var(--gradient-primary)' }}>
        {/* Decorative blobs */}
          ...
          <div className="grid grid-cols-2 border-b border-border">
            {(['login', 'register'] as Tab[]).map(t => (
              ...
              >
                ...
                {tab === t && (
                  <span className="absolute bottom-0 inset-x-0 h-0.5 rounded-t-full transition-all duration-300"
            ...
            {tab === 'login' && (
              ...
              <form onSubmit={handleLogin} className="space-y-4">
                ...
                <button
                  type="submit"
                  disabled={loading}
                  className="w-full h-12 rounded-xl text-primary-foreground font-semibold text-sm flex items-center justify-center gap-2 active:opacity-80 disabled:opacity-60 transition-opacity mt-1"
                  style={{ background: 'var(--gradient-primary)' }}
                >
                  {loading
              ...
              <div className="mt-4 space-y-3">
                <div className="relative flex items-center">
                  ...
                  <span className="mx-3 text-xs text-muted-foreground uppercase">或使用</span>
                  <div className="flex-1 border-t border-border" />
                </div>
                <button
                  type="button"
