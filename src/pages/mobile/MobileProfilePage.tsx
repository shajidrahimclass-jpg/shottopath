  ...
  return (
    <MobileLayout>
      ...
      <div className="relative">
        {/* Wide gradient bg */}
        <div className="h-36 w-full relative overflow-hidden bg-primary text-primary-foreground">
          {/* Decorative circles */}
        ...
        <div className="px-4 -mt-12">
          <div className="bg-card rounded-3xl border border-border/40 shadow-xl p-4">
            <div className="flex items-end gap-4 -mt-10 mb-3">
              {/* Avatar */}
              <div className="h-20 w-20 rounded-2xl border-4 border-card shrink-0 flex items-center justify-center bg-primary text-primary-foreground font-black text-2xl shadow-xl">
                {initials}
              </div>
