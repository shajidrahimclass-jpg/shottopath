...
export default function MobileProductDetailPage() {
  ...
  return (
    <MobileLayout>
      <PageMeta product={product} title={product.name} />
      ...
      <div className="px-4 pt-5 pb-32 space-y-5">
        ...
        {product.meta_description && (
          <div className="bg-muted/40 rounded-2xl p-4">
            <h3 className="font-black text-sm mb-2">Highlights</h3>
        ...
        {product.user_manual && (
          <div className="bg-primary/5 rounded-2xl p-4 border border-primary/20">
            <h3 className="font-black text-sm mb-2 text-primary flex items-center gap-1.5">
              <Star className="h-4 w-4" /> User Manual & Terms
            </h3>
            <p className="text-sm text-muted-foreground leading-relaxed text-pretty whitespace-pre-wrap">
              {product.user_manual}
            </p>
