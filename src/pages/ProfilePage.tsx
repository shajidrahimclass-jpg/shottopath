...
import { Plus, Trash2, User, MapPin, Edit, Package, ShoppingBag, Home, Briefcase, MoreHorizontal, Star } from 'lucide-react';
            ...
            <CardContent className="p-4 md:p-6">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs md:text-sm font-semibold capitalize">{profile?.role}</p>
                </div>
              </div>
            </CardContent>
          </Card>
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                ...
                <div>
                  ...
                  <p className="text-sm md:text-base font-semibold">{profile?.username}</p>
                </div>
                ...
                <div>
                  ...
                  <p className="text-sm md:text-base font-semibold break-all">{profile?.email || 'Not provided'}</p>
                </div>
