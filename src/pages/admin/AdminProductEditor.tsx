      ...
      <div className="space-y-4 md:space-y-6">
        ...
        <form onSubmit={handleSubmit}>
          <div className="grid gap-4 md:gap-6">
            ...
            <Card>
              ...
              <CardContent className="space-y-6">
                ...
                <div className="space-y-2">
                  ...
                  />
                  <p className="text-sm text-muted-foreground">
                    Single responsive thumbnail — automatically fits all device sizes.
                  </p>
                </div>
              </CardContent>
            </Card>
            ...
            {/* Device-Specific Images replaced with single responsive gallery */}
            <Card>
              <CardHeader>
              ...
              <CardContent className="space-y-4">
                <p className="text-sm text-muted-foreground">
                  Upload product gallery images. They will automatically be displayed responsively on all device sizes.
                </p>
                <ImageUpload
                  onUploadComplete={(url) => {
                    setFormData(prev => ({
                  ...
                  <div className="grid grid-cols-4 gap-2 mt-2">
                    {formData.pc_images.map((url, index) => (
                      <div key={index} className="relative group">
                        <div className="aspect-square bg-background rounded border flex items-center justify-center p-2 overflow-hidden">
                          <img
                            src={url}
