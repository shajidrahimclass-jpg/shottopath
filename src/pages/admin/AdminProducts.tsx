...
import { getAllProducts, deleteProduct, getProductSalesStats } from '@/db/api';
...
export default function AdminProducts() {
  ...
  const [salesStats, setSalesStats] = useState<Record<string, { totalSold: number, revenue: number }>>({});
              ...
              <Table>
                <TableHeader>
                  <TableRow>
                    ...
                    <TableHead className="min-w-[120px]">Sales</TableHead>
                      ...
                      <TableCell>
                        <div className="flex flex-col gap-1">
                          <span className="text-sm font-medium flex items-center gap-1">
                            ...
                            {salesStats[product.id]?.totalSold || 0} sold
                          </span>
                          <span className="text-xs text-muted-foreground flex items-center gap-1">
                            <DollarSign className="h-3 w-3" />
                            ৳{(salesStats[product.id]?.revenue || 0).toLocaleString()}
                          </span>
                        </div>
                      </TableCell>
                      <TableCell>
                  ...
                  <div className="flex gap-4">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="mt-2 space-y-1 text-sm">
                        ...
                        {product.category && (
                          <p className="text-muted-foreground flex items-center justify-between">
                            <span><span className="font-medium">Category:</span> {product.category}</span>
                            <span className="font-medium text-foreground flex items-center gap-1">
                              <DollarSign className="h-3 w-3" />
                              ৳{(salesStats[product.id]?.revenue || 0).toLocaleString()}
                            </span>
