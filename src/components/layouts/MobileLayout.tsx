...
import { Home, Package, ShoppingCart, ClipboardList, User, MessageCircle, Bell, Sparkles, Search } from 'lucide-react';
...
export const MOBILE_BASE = '/cjwjkkeojejdhishwihswugudhijeid/mobile/shottopath/op';
...
export function MobileLayout({ children }: MobileLayoutProps) {
  ...
  const tabs = user ? [
    ...
    { path: MOBILE_ROUTES.products, icon: Package,      label: 'Shop',   badge: 0 },
    { path: MOBILE_ROUTES.cart,     icon: ShoppingCart, label: 'Cart',   badge: cartCount },
    { path: `${MOBILE_BASE}/track-order`, icon: Search, label: 'Track',  badge: 0 },
