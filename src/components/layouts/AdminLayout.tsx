...
export const getAdminNavItems = () => [
  ...
  { path: adminPath('web-analytics'), label: 'Web Analytics', icon: Globe, keywords: ['google', 'analytics', 'ga4', 'traffic', 'visitors'] },
  { path: adminPath('social'), label: 'Social Media', icon: Globe, keywords: ['social', 'facebook', 'twitter', 'instagram', 'youtube'] },
...
export function AdminLayout({ children }: AdminLayoutProps) {
  ...
  const adminNavItems = React.useMemo(() => getAdminNavItems(), [appSettings?.admin_url_path]);
  ...
  return (
    <div className="min-h-screen flex">
      ...
      <div className="flex-1 flex flex-col min-w-0">
        ...
        <main className="flex-1 p-4 md:p-6 overflow-x-hidden overflow-y-auto pb-20 lg:pb-6 min-w-0 relative">
