...
// @ts-ignore
const WishlistContext = globalObj.__WishlistContext || createContext<WishlistContextType | undefined>(undefined);
// @ts-ignore
if (import.meta.env.DEV) globalObj.__WishlistContext = WishlistContext;
