...
// @ts-ignore
const AppSettingsContext = globalObj.__AppSettingsContext || createContext<AppSettingsContextType | undefined>(undefined);
// @ts-ignore
if (import.meta.env.DEV) globalObj.__AppSettingsContext = AppSettingsContext;
