...
// @ts-ignore
const KeyboardShortcutsContext = globalObj.__KeyboardShortcutsContext || createContext<KeyboardShortcutsContextType | undefined>(undefined);
// @ts-ignore
if (import.meta.env.DEV) globalObj.__KeyboardShortcutsContext = KeyboardShortcutsContext;
